-- Media Files and Transcription Schema for Law Firm SMS System
-- This schema supports audio/video file uploads, transcription, and client linking

-- Enable necessary extensions
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Create custom types for transcription status
...
CREATE INDEX idx_media_files_client_id ON media_files(client_id);
CREATE INDEX idx_media_files_status ON media_files(transcription_status);
CREATE INDEX idx_media_files_created_at ON media_files(created_at);
CREATE INDEX idx_media_files_cleanup_scheduled ON media_files(cleanup_scheduled_at);
CREATE INDEX idx_media_files_case_number ON media_files(case_number);

-- Create a full-text search index for transcripts and filenames
