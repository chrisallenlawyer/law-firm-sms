              ...
              <div className="overflow-hidden">
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {campaigns.map((campaign: { id: string; name: string; status: string; successful_sends: number; total_recipients: number; created_at: string; docket?: { court?: { name: string }; docket_date: string }; template?: { name: string }; created_by_user?: { name: string } }) => (
                      <tr key={campaign.id}>
